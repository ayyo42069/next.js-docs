...
slug: "/docs/app/api-reference/config/next-config-js/serverExternalPackages"
date_crawled: "2025-04-06T12:10:42.403138+00:00"
---

**Path**: /docs/app/api-reference/config/next-config-js/serverExternalPackages
