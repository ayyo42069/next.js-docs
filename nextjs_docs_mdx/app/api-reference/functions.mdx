...
date_crawled: "2025-04-06T12:11:06.529803+00:00"
---

**Path**: /docs/app/api-reference/functions
...
API Reference for the unstable\_cache function.](/docs/app/api-reference/functions/unstable_cache)[### unstable\_noStore

API Reference for the unstable\_noStore function.](/docs/app/api-reference/functions/unstable_noStore)[### unstable\_rethrow

API Reference for the unstable\_rethrow function.](/docs/app/api-reference/functions/unstable_rethrow)[### useLinkStatus

API Reference for the useLinkStatus hook.](/docs/app/api-reference/functions/use-link-status)[### useParams
