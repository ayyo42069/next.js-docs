...
date_crawled: "2025-04-06T12:11:39.202084+00:00"
---

**Path**: /docs/app/building-your-application/deploying/production-checklist
...
[Building Your Application](/docs/app/building-your-application)[Deploying](/docs/app/building-your-application/deploying)Production Checklist
...
* **[Static Rendering](/docs/app/building-your-application/rendering/server-components#static-rendering-default):** Next.js statically renders Server and Client Components on the server at build time and caches the rendered result to improve your application's performance. You can opt into [Dynamic Rendering](/docs/app/building-your-application/rendering/server-components#dynamic-rendering) for specific routes, where appropriate.
