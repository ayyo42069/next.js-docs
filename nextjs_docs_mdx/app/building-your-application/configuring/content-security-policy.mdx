...
date_crawled: "2025-04-06T12:11:30.582887+00:00"
---

**Path**: /docs/app/building-your-application/configuring/content-security-policy
...
[Building Your Application](/docs/app/building-your-application)[Configuring](/docs/app/building-your-application/configuring)Content Security Policy
...
Learn how to use Middleware to run code before a request is completed.](/docs/app/building-your-application/routing/middleware)[### headers

API reference for the headers function.](/docs/app/api-reference/functions/headers)
