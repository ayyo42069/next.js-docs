...
date_crawled: "2025-04-06T12:11:38.030105+00:00"
---

**Path**: /docs/app/building-your-application/deploying
...
[App Router](/docs/app)[Building Your Application](/docs/app/building-your-application)Deploying
...
Recommendations to ensure the best performance and user experience before taking your Next.js application to production.](/docs/app/building-your-application/deploying/production-checklist)[### Static Exports

Next.js enables starting as a static site or Single-Page Application (SPA), then later optionally upgrading to use features that require a server.](/docs/app/building-your-application/deploying/static-exports)[### Multi-Zones

Learn how to build micro-frontends using Next.js Multi-Zones to deploy multiple Next.js apps under a single domain.](/docs/app/building-your-application/deploying/multi-zones)
