...
title: "turbo"
description: "Menu..."
url: "https://nextjs.org/docs/pages/api-reference/config/next-config-js/turbo"
slug: "/docs/pages/api-reference/config/next-config-js/turbo"
date_crawled: "2025-04-06T12:13:02.349080+00:00"
---

**Path**: /docs/pages/api-reference/config/next-config-js/turbo
...
[Configuration](/docs/pages/api-reference/config)[next.config.js Options](/docs/pages/api-reference/config/next-config-js)turbo
...
### [Assigning module IDs](#assigning-module-ids)
