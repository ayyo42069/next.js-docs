...
date_crawled: "2025-04-06T12:14:03.421595+00:00"
---

**Path**: /docs/pages/building-your-application/upgrading/app-router-migration
...
[Building Your Application](/docs/pages/building-your-application)[Upgrading](/docs/pages/building-your-application/upgrading)From Pages to App
...
* The `app` directory supports nested routes *and* layouts. [Learn more](/docs/app/building-your-application/routing).
